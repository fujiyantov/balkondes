! function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        const options = {
            method: 'GET',
            /* headers: {
                'X-RapidAPI-Key': '2bfba48b15msh0f4ae91c053bee9p110e6djsn57d41ffc6c09',
                'X-RapidAPI-Host': 'countries-cities.p.rapidapi.com'
            } */
        };

        fetch('https://raw.githubusercontent.com/mul14/gudang-data/master/bank/bank.json', options)
            .then(response => response.json())
            .then(response => response)
            .catch(err => console.error(err));
        // RV-Location Desa and Object object
        module.exports = {
            intro: {
                next: "culture",
                type: "intro",
            ...
            /* culture: {
                ...
                content: {
                    ...
                    number: "01",
                    icons: ["video"],
                    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse eget blandit metus.",
                    ...
                    captions: [{
                        id: "0",
                        content: "Please help us to protect this place",
                        start: "78",
                        end: "80"
                    }, {
                        id: "1",
