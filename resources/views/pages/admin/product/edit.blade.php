                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.update', $products->id) }}" method="POST"
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control lat @error('lat') is-invalid @enderror" name="lat"
                                            type="text" value="{{ $products->lat }}" required />
                                        @error('lat')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control lon @error('long') is-invalid @enderror" name="long"
                                            type="text" value="{{ $products->long }}" required />
                                        @error('long')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control @error('video_id') is-invalid @enderror" name="video_id"
                                            type="text" value="{{ $products->video_id }}" required />
                                        @error('video_id')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-12">
                                        @if (substr($products->image, 0, 5) == 'https')
