                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('products.index') }}">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control @error('video_id') is-invalid @enderror" name="video_id"
                                            ...
                                            placeholder="Masukan Video ID produk" />
                                        @error('video_id')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" cols="30" rows="5" name="address"
                                            value="{{ old('address') }}" required placeholder="Masukan alamat lengkap"></textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" cols="30" rows="25"
                                            name="description" value="{{ old('description') }}" required placeholder="Masukan deskripsi singkat produk"></textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <!-- Form Group (first name)-->
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="name">Informasi Produk</label>
                                        <textarea class="form-control @error('additional_information') is-invalid @enderror" cols="30" rows="25"
                                            ...
                                            placeholder="Masukan informasi detail produk"></textarea>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control @error('seller_name') is-invalid @enderror"
                                            name="seller_name" type="text" value="{{ old('seller_name') }}" required
