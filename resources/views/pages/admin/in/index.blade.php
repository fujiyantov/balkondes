                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="number" name="name" class="form-control" placeholder="Masukan Namo Ajuan"
                                    required>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="perihal" class="form-control" placeholder="Masukan Perihal"
                                    required>
                            </div>
                            <div class="col-md-12">
