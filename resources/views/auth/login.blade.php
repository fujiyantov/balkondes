            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header justify-content-center"><h3 class="fw-light my-4">Login Page</h3></div>
                        <div class="card-body">
                            ...
                            <form action="/login" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="password" name="password" type="password" placeholder="Enter password" required aria-describedby="passwordlHelp"/>
